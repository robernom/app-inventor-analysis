...
\grex{Yes, and provide a link to the file as a footnote}
...
Counting the most and least used blocks for all projects we obtain the results shown in Table~\ref{tab:most-least}. \grex{Elaborate on the results!}
...
While for projects with a variety less than 10, results can be seen in Table~\ref{tab:most-least-small}. \grex{Elaborate on the results!}
